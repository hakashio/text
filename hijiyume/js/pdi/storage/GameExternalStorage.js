...
var GameExternalStorage = /** @class */ (function () {
    ...
    GameExternalStorage.prototype._readSync = function (req) {
        ...
        if (playerIds && type === "ordered-number")
            throw new Error("could not read value for key ".concat(req.key, " specified playerIds and ordered-number"));
        ...
        var failed = data.map(function (_a) {
            ...
            if (typeof value !== "number") {
                if (value != null && type !== "string" && type !== "general") {
                    throw new Error("type mismatch: the value ".concat(value, " for player ").concat(playerId, " does not match the type ").concat(type));
                }
            ...
            if (needsCalc) {
                if (playerId in dataTable) {
                    ...
                    throw new Error("no value for key ".concat(key, " of player ").concat(playerId));
                }
            }
            var calculated = 
