 ...
 * - "global": プレイに紐づかない領域
 */
export declare type StoragePlayScope = "play" | "rootPlay" | "global";
/**
 * ストレージに保存される値の型。
 */
export declare type StorageValue = number | string | Object | null;
/**
 * ストレージに保存される値の種類。
 *
 ...
 */
export declare type StorageValueType = "number" | "ordered-number" | "string" | "general";
/**
 * 値の読み込み順。
 *
 ...
 */
export declare type StorageReadOrder = "asc" | "desc" | "unspecified";
/**
 * 書き込みのタイプ (書き込む値の解釈)。
 *
 ...
 */
export declare type StorageWriteType = "incr" | "decr" | "overwrite";
/**
 * "number" の最小値。
 */
export declare const STORAGE_MIN_NUMBER = -1073741824;
/**
 * "number" の最大値。
 */
export declare const STORAGE_MAX_NUMBER = 1073741823;
 ...
 * - "none": 条件なく書き込む。デフォルト。
 */
export declare type StorageWriteCondition = "greaterThan" | "lessThan" | "none";
/**
 * 書き込み失敗の種別。
 * それぞれ min を下回った、max を超過した、許可されていない。
 */
export declare type StorageWriteFailureType = "subceedMin" | "exceedMax" | "notPermitted";
