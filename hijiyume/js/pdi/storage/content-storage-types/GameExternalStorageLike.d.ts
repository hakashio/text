import { StoragePlayScope, StorageValueType, StorageReadOrder, StorageWriteType, StorageData, StorageWriteFailureType } from "./types";
/**
 * GameExternalStorageReadRequest.limitのデフォルト値
 */
export declare const DEFAULT_STORAGE_READ_REQUEST_LIMIT = 10;
/**
 * GameExternalStorageReadRequest.offsetのデフォルト値
 */
export declare const DEFAULT_STORAGE_READ_REQUEST_OFFSET = 0;
/**
 * ストレージの領域を識別する情報。
 *
